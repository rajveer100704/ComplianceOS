...
class SnapshotRepository(BaseRepository[ReviewSnapshotModel]):
    ...
    async def get_by_version(self, request_id: int, version: int) -> Optional[ReviewSnapshotModel]:
    ...
    async def get_all_for_request(self, request_id: int) -> List[ReviewSnapshotModel]:
        ...
        stmt = (
            ...
            .where(ReviewSnapshotModel.request_id == request_id, ReviewSnapshotModel.is_deleted == False)

...
def fallback_to_sqlite():
    ...
    logger.warning("PostgreSQL connection refused. Falling back to local SQLite database...")
    from sqlalchemy.ext.asyncio import create_async_engine
    engine = create_async_engine("sqlite+aiosqlite:///compliance.db?timeout=30", echo=False)

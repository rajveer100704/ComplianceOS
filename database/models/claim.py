...
class ClaimModel(Base, AuditMixin):
    ...
    reviewer_decision: Mapped[str] = mapped_column(String(50), default="Needs Review", nullable=False)
    ...
    comments_list = relationship("ClaimCommentModel", back_populates="claim", cascade="all, delete-orphan")
    pinned_evidences_list = relationship("PinnedEvidenceModel", back_populates="claim", cascade="all, delete-orphan")

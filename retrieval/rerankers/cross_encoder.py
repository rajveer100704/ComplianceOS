...
class CrossEncoderReranker(BaseReranker):
    ...
    def __init__(self, model_name: str = "cross-encoder/ms-marco-MiniLM-L-6-v2", device: str = "auto", warmup: bool = True):
        self.model_name = model_name
        self.device = device
        self.model = ModelManager.load_reranker_model(model_name, device=device, warmup=warmup)

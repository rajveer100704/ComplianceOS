...
class DocumentGraph:
    ...
    child_parent: Dict[str, str] = field(default_factory=dict)  # maps child_id to parent_id
    parent_children: Dict[str, List[str]] = field(default_factory=dict)  # maps parent_id to child_ids list
    sibling_links: Dict[str, Tuple[Optional[str], Optional[str]]] = field(default_factory=dict)  # maps chunk_id to (prev_chunk_id, next_chunk_id)
